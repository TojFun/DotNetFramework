...
<asp:Content ID="Content1" ContentPlaceHolderID="OptionsScreen" runat="server">
    ...
    <section class="s2">
        ...
        <p>
            ...
            שיצרו צד שלישי. Skills מאפשרים חיבור למגוון רחב של שירותים ודרכם מוצרי בית חכם צד שלישי נכנסים
            לבית. הSkills הם היתרון המרכזי של Amazon על המתחרות, והם מאפשרים לכל אחד להציע את מוצריו בשוק
            של Alexa.
        </p>
        <p>
            Alexa נפוצה מאוד בארצות הברית ורוב הבתים בוחרים בה, בעיקר בזכות התמיכה הרחבה. המחירים של Amazon
            זולים יותר משל שתי המתחרות. בנוסף, בעיקר לשוק האמריקאי, Amazon היא פלטפורמה נגישה מאוד, ומוצרים
            מגיעים מאוד מהר.
        </p>
        <p>
            אולם, Alexa היא לא נוחה ואינטואיטיבית כמו המתחרות שלה. היא יותר מסורבלת, וחווית המשתמש פחות טובה
            מאצל האחרות. כמו כן, בישראל, האפליקציה של Alexa לא זמינה להורדה, והדרך היחידה לעקוף את זה היא
            לשנות את חנות האפליקציות לארץ אחרת.
        </p>
        <p>
            לסיכום, לAlexa יש תמיכה רחבה בשוק והיא מאפשרת יותר חופש מהאחרות. אם מגוון וחופש יותר קריטי לך
            מחוויית משתמש ואין לך בעיה "לכלך קצת את הידיים" כדי להוריד את האפליקציה, Alexa היא בשבילך.
        </p>
    </section>
